    ...
    var methods = {
        init: function (options) {
            var p = {
                ...
                tourTitle:'乐公默认标题',				//Tour title
				tourSubtitle:'乐公默认子标题',
                ...
                intro:{										//Default intro settings
					...
					title:'欢迎您来到短链系统控制台',												//Title of introduction dialog
					content:'接下来将为您介绍控制台的使用方法哦！',					//Content of introduction dialog
                ...
                continue:{									//Default the continue message settings
					...
					title:'继续您先前的操作吗?',											//Title of continue dialog
                    content:'点击继续到您上次退出的地方.',		//Content of continue dialog
                ...
                steps:[{									//Default step settings
                    ...
                    title:'新步骤标题',					//Name of step
                    content:'新步骤描述',			//Description of step
                    ...
                    event:'下一步',							//An event that you need to do to go to the next step
                    ...
                    nextText:'下一步',						//The text in the Next Button
                    prevText:'上一步',						//The text in the Prev Button
                ...
                lang: {										//Default language settings
                    cancelTitle: '取消引导',				//The title in the cancel tour button
                    cancelText: '×',						//The text in the cancel tour button
                    hideText: '收起引导图',				//The text in the hidden tour map button 
                    tourMapText:'≡',						//The text in the show tour button
                    tourMapTitle: '引导图',				//Title of Tour map button
                    nextTextDefault:'下一步',					//The text in the Next Button
                    prevTextDefault:'上一步',					//The text in the Prev Button
                    endText:'结束引导',						//The text in the End Tour Button

                    contDialogBtnBegin:'再看一次',		//Text in the start button of continue dialog 
                    contDialogBtnContinue:'继续',		//Text in the continue button of continue dialog 
                    
                    introDialogBtnStart:'开始',			//Text in the start button of introduction dialog
                    introDialogBtnCancel:'取消',			//Text in the cancel button of introduction dialog
                   
					modalIntroType:'新手引导',			//Type Name of intro dialog
					modalContinueType:'未完成的操作'		//Type Name of continue dialog
                },
