                       ...
                       <form  class="form-signin" id="form_huifu" method="POST">
                        <div class="form-group">
                          <input type="hidden" id="id" name="id" value="<?php echo $id;?>">
                                            <label>输入IP</label>
                                            <textarea rows="5" id="info" class="form-control border-input" placeholder="请输入要禁用的IP" name="info"></textarea>
                                        </div>
                      <div class="text-center">
                                        <button id="submit" type="button" class="btn btn-warning">提交IP</button>
                                      </div></form></div></div>
            </footer>
    </div>
  </div>
