...
if(isset($_GET['edit'])) {
  $id=$_GET['id'];
  $user=$DB->query("select * from hgfh_domain where id='{$id}' limit 1")->fetch();
}
if(isset($_GET['bianji'])) {
   if($islogin=1){
    ...
    $sql = $DB->exec("UPDATE `hgfh_domain` SET `url`='{$url}',`vip`='{$vip}',`zt`='{$zt}' WHERE id='{$id}'");
  if($sql){
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">编辑域名</li>
                                </ol>
                            </div>
                            <h4 class="page-title">编辑域名</h4>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">域名编辑</h4>
                                <p class="text-muted font-14">
                                   以下是域名<?=$user['url']?>的资料，保存会对域名更改！
                                </p>
                                ...
                                <form class="form-horizontal" id="form_set" method="POST">
                                  <input type="hidden" name="id" value="<?php echo $user['id'];?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="url" value="<?php echo $user['url']; ?>">
                                        </div>
                                    </div>
                                  ...
                                  <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <option value="0" <?=$user['zt']==0?"selected":""?>>报毒</option>
                                        </select>
                                        </div>
                                    <label class="col-sm-1 col-form-label">是否为VIP域名？</label>
                                    <div class="col-sm-5">
