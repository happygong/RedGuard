...
if(isset($_GET['add'])) {
   if($islogin=1){
        ...
        $reason = daddslashes($_POST['reason']);
        //$xs = daddslashes($_POST['display']);
        $row1=$DB->query("SELECT * FROM `hgfh_banlink` WHERE link='{$link}' limit 1")->fetch();
                  if ($row1) {
                    exit('{"code":-1,"msg":"该链接已被添加过！"}');
                  }
    $sql = $DB->exec("INSERT INTO `hgfh_banlink` (`reason`, `date`, `link`) VALUES ('{$reason}', '{$date}','{$link}')");
  if($sql){
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">添加报毒链接</li>
                                </ol>
                            </div>
                            <h4 class="page-title">添加报毒链接</h4>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">报毒链接添加</h4>
                                ...
                                <form class="form-horizontal" id="form_set" method="POST">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">报毒的链接</label>
                                        <div class="col-sm-10">
                                    ...
                                    <button id="submit" type="button" class="btn btn-primary">添加链接</button>
                                </form>
