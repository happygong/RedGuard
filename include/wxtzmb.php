...
<script>
if(navigator.userAgent.indexOf("QQ/" || "TIM/" || "Alipay"))>0){
 var brand = window.location.search;
 var brand4=brand.substr(brand.length-6);
 if(brand4 != \'%27%29\'){
  var url = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search + "&alert%28urlfh%27%29";
  window.location.href=url;
 }
}else if(navigator.userAgent.indexOf("MicroMessenger")>0){
}else{
	window.location.href="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1578223555181&di=3ec3ddc21e73882ac7dbd9f895e9dc2a&imgtype=jpg&src=http%3A%2F%2Fimg2.imgtn.bdimg.com%2Fit%2Fu%3D1785082387%2C1340400530%26fm%3D214%26gp%3D0.jpg";
}
</script>
	<style type="text/css">
		.loader {
